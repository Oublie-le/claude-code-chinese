...
const RIGHT_HINT_SUFFIX = ` (${t('tagtabs.tabToCycle')})`
const RIGHT_HINT_NO_COUNT = `(${t('tagtabs.tabToCycle')})`
...
export function TagTabs({
  ...
  const resumeLabel = showAllProjects ? t('tagtabs.resumeAllProjects') : t('tagtabs.resume')
